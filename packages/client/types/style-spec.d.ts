declare module "@mapbox/mapbox-gl-style-spec" {
  ...
  export namespace expression {
    ...
    export type StylePropertyType = "color" | "string" | "number" | "enum" | "boolean" | "formatted" | "image";

    export interface StylePropertySpecification {
      type: StylePropertyType;
    }

    export function createExpression(expr: any, propertySpec?: StylePropertySpecification): ParseResult;
  }
}
